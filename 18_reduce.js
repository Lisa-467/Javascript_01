...
console.log(
  `====== WAP to find all the students whose id is odd value and find it's marks average========`
);
...
console.log(
  `Total marks is ${sumOfMarks}, and Number of Students with odd id is ${array.length}`
);
